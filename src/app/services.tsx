...
const SERVICES = [
  ...
  },
  {
    ...
    description:
      "يقدم فني تركيب دش أبها وخميس خدمات تركيب جميع باقات القنوات المشفرة مثل BeIN Sports وOSN لضمان استقبال جميع قنواتك المفضلة.",
    image: "/image/services/seven.jpg",
    details: "يقوم الفني بتركيب وتفعيل جميع باقات القنوات الرياضية والترفيهية، بما في ذلك باقة BeIN Sports، لضمان استقبال جميع القنوات بجودة عالية دون أي مشاكل. كما نقدم خدمات المساعدة في اختيار الباقة المناسبة لك وتجهيز كافة المتطلبات.",
