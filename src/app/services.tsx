...
const SERVICES = [
  ...
  {
    title: "صيانة الدش الدورية",
    description:
      "صيانة دورية للحفاظ على نظام الدش يعمل بسلاسة. تشمل الفحص والتنظيف والضبط الدقيق لجميع المكونات لمنع انقطاع الإشارة وإطالة عمر المعدات.",
  ...
  {
    title: "بيع وتركيب أجهزة الاستقبال (الرسيفرات)",
    description:
      "بيع أجهزة الاستقبال وتركيبها باحترافية، مع المساعدة في اختيار الجهاز المناسب حسب باقات القنوات وقوة الإشارة واحتياجات المشاهدة.",
  ...
  {
    title: "ضبط ومعايرة إشارة الدش",
    description:
      "ضبط دقيق لزاوية الدش وترددات نايل سات وعرب سات باستخدام أجهزة قياس الإشارة، للتخلص من التقطيع وضعف الاستقبال.",
  ...
  {
    title: "تأسيس أنظمة الدش للمباني",
    description:
      "تأسيس نظام دش مركزي أو عادي للمنازل والمكاتب والعمائر، يشمل التمديدات الداخلية والخارجية وتوزيع الإشارة على جميع الوحدات.",
  ...
  {
    title: "إعداد أجهزة IPTV وضبط الشبكة",
    description:
      "إعداد أجهزة IPTV وضبط إعدادات الشبكة وتركيب التطبيقات، والمساعدة في تفعيل الاشتراكات النظامية وحل مشاكل التقطيع.",
    image: "/image/services/seven.jpg",
    details: "يقوم الفني بإعداد جهاز IPTV وربطه بشبكة الإنترنت المنزلية، وضبط إعدادات الراوتر عند الحاجة، وتركيب التطبيق الرسمي وإدخال بيانات الاشتراك النظامي، مع اختبار جودة البث ومعالجة أسباب التقطيع مثل ضعف الشبكة أو إعدادات DNS.",
    features: ["إعداد الجهاز والتطبيق", "ضبط إعدادات الشبكة", "اختبار جودة البث", "معالجة أسباب التقطيع", "دعم فني بعد التركيب"],
    duration: "1-2 ساعات",
    price: "حسب الخدمة"
  },
  {
    title: "تركيب الشاشات والتلفزيونات",
    description:
      "تركيب الشاشات على الجدار بالحامل المناسب، وتوصيلها بأنظمة الدش والرسيفر ومكبرات الصوت، وضبط الصورة والصوت.",
    image: "/image/services/six.jpg",
  ...
  },
  {
    ...
    description:
      "تركيب كاميرات المراقبة للمنازل والمحلات والشركات، مع اختيار النظام المناسب وربطه بالجوال لمتابعة البث المباشر.",
        ...
        <div className="container mx-auto relative z-10">
          ...
          <div className="text-center mb-20">
            ...
            <Typography variant="h2" color="blue-gray" className="mb-6 text-4xl lg:text-6xl font-bold bg-gradient-to-r from-blue-700 to-purple-700 bg-clip-text text-transparent" {...({} as any)}>
              تفاصيل خدمات الدش والرسيفرات وكاميرات المراقبة
            </Typography>
          ...
          <div className="relative bg-white rounded-3xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto transform transition-all duration-300 scale-100">
            ...
            <div className="p-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <button
                  onClick={() => window.open('https://wa.me/966558202859?text=' + encodeURIComponent('مرحباً، أرغب بالاستفسار عن: ' + SERVICES[selectedService].title + ' في خميس مشيط'), '_blank')}
