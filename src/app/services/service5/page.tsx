...
export default function Service5Page() {
  const service = {
    ...
    description:
      "خبراء ضبط إشارات الأقمار والترددات للحصول على أفضل جودة إشارة باستخدام أحدث التقنيات.",
    image: "/image/services/five.jpg",
    details:
      "نستخدم أحدث أجهزة الكشف عن الإشارة لضبط دقيق لإشارات الأقمار الصناعية والترددات، مما يضمن جودة صورة وصوت فائقة وخدمة سريعة وفعالة.",
      ...
      <section className="bg-gray-50 py-16 px-6">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="md:w-1/2 text-gray-800">
            <h3 className="text-xl font-bold mb-4">ضبط دقيق وإشارة قوية</h3>
            <p>{service.details}</p>
