...
export default function Service4Page() {
  const service = {
    ...
    details:
      "يتم اختيار الأجهزة بعناية وتركيبها باحترافية لضمان تجربة مشاهدة ممتازة، كما نقدم خدمات تأسيس متكاملة لضمان أداء متميز.",
      ...
      <section className="bg-gray-50 py-16 px-6">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="md:w-1/2 text-gray-800">
            <h3 className="text-xl font-bold mb-4">تركيب وتشغيل احترافي</h3>
            <p>{service.details}</p>
