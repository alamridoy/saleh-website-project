...
export default function Service6Page() {
  const service = {
    ...
    description:
      "نوفر خدمات تأسيس نظام دش مركزي أو عادي في المنازل والمكاتب لضمان أداء متميز واستقبال عالي الجودة.",
    image: "/image/services/six.jpg",
    details:
      "خدماتنا تشمل التمديدات الداخلية والخارجية، توزيع الإشارة على كافة الوحدات، وتركيب كافة الملحقات باحترافية عالية لضمان نظام متين وفعال.",
      ...
      <section className="bg-gray-50 py-16 px-6">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="md:w-1/2 text-gray-800">
            <h3 className="text-xl font-bold mb-4">تأسيس احترافي ومتين</h3>
            <p>{service.details}</p>
