...
export default function Service3Page() {
  const service = {
    ...
    details:
      "خدمات إصلاح خبراء لجميع أنواع مشاكل أطباق الأقمار الصناعية بما في ذلك مشاكل الإشارة، والمكونات التالفة، وتلف الطقس، ومشاكل المحاذاة. نستخدم قطع غيار أصلية ونقدم ضمانًا على جميع الإصلاحات.",
      ...
      <section className="bg-gray-50 py-16 px-6">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="md:w-1/2 text-gray-800">
            <h3 className="text-xl font-bold mb-4">إصلاح سريع وموثوق</h3>
            <p>{service.details}</p>
