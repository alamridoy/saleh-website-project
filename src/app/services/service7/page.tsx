...
export default function Service7Page() {
  const service = {
    title: "تركيب رسيفرات BeIN SPORTS, OSN",
    description:
      "خدمات تركيب جميع باقات القنوات المشفرة لضمان استقبال جميع قنواتك المفضلة بأعلى جودة.",
    image: "/image/services/seven.jpg",
    details:
      "نقوم بتركيب وتفعيل جميع باقات القنوات الرياضية والترفيهية، مع ضمان جودة عالية دون أي مشاكل، بالإضافة إلى تقديم الدعم الفني والنصائح اللازمة لاختيار الباقة المناسبة.",
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="flex-1 max-w-5xl mx-auto py-16 px-6">
        ...
        <div className="mt-12 text-center">
          <a href="tel:+966558202859" className="inline-block px-8 py-4 bg-gradient-to-r from-cyan-500 to-purple-500 text-white font-semibold rounded-full shadow-lg hover:scale-105 transition-transform duration-300">
      ...
      <section className="bg-gray-50 py-16 px-6">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-8">
          <img src={service.image} alt={service.title} className="w-full md:w-1/2 rounded-lg shadow-lg object-cover"/>
          <div className="md:w-1/2 text-gray-800">
            <h3 className="text-xl font-bold mb-4">تركيب سريع واحترافي</h3>
            <p>{service.details}</p>
