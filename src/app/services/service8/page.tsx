...
export default function Service8Page() {
  const service = {
    ...
    description:
      "دعم مستمر لجميع المشاكل المتعلقة بالأقمار الصناعية، مع المساعدة الفنية على مدار الساعة والإصلاحات الطارئة.",
    image: "/image/services/eight.jpg",
    details:
      "خدمة دعم عملاء شاملة بما في ذلك المساعدة الفنية على مدار الساعة، والإصلاحات الطارئة، وإرشادات استكشاف الأخطاء وإصلاحها، وضمان تشغيل نظام القمر الصناعي بسلاسة.",
      ...
      <section className="bg-gray-50 py-16 px-6">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="md:w-1/2 text-gray-800">
            <h3 className="text-xl font-bold mb-4">دعم مستمر وحل سريع للمشاكل</h3>
            <p>{service.details}</p>
