...
const maps = [
  {
    ...
    title: "محل حسن للإلكترونيات - تركيب دش بخميس مشيط",
  },
];
  ...
  return (
    <section className="px-8 pt-40 pb-20" dir="rtl">
      ...
      <div className="sr-only">
        موقع محل حسن للإلكترونيات في خميس مشيط - شارع الثلاثين بحي
        الخالدية، مقابل مدرسة الخالدية الابتدائية. أفضل محل دش قريب منك
        بخميس مشيط لخدمات تركيب دش مركزي وعادي، صيانة دش ورسيفرات IPTV وHD،
        بيع رسيفرات وأطباق دش عالية الجودة، تركيب كاميرات، فني دش وتركيب
        شاشات، اشتراك قنوات بين سبورت، محل رسيفرات خميس مشيط، وتمديد أسلاك
        عالية الجودة.
      </div>
    </section>
  );
