...
export const metadata: Metadata = {
  ...
  description:
    "محل حسن للإلكترونيات يقدم أفضل خدمات تركيب دش خميس مشيط: تركيب دش مركزي وعادي، صيانة دش ورسيفرات IPTV وHD، بيع رسيفرات وأطباق دش عالية الجودة، تركيب كاميرات مراقبة وشاشات بخميس مشيط، واشتراكات بين سبورت. فني تركيب أطباق أقمار صناعية بالقرب منك. رقم الفني 0558202859.",
  keywords: [
    "فني دش خميس مشيط",
    "تركيب دش خميس مشيط",
    "صيانة دش خميس مشيط",
  ...
  openGraph: {
    title:
      "محل حسن للإلكترونيات | تركيب دش مركزي وصيانة رسيفرات IPTV وHD وكاميرات مراقبة وشاشات | خميس مشيط",
    description:
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "mainEntity": [
                ...
                {
                  "@type": "Question",
                  "name": "هل تقومون بتركيب الشاشات في خميس مشيط؟",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "نعم، فني دش وتركيب شاشات محل حسن للإلكترونيات يقدم خدمة تركيب الشاشات على الحائط وتوصيلها بأنظمة الدش والرسيفر في خميس مشيط."
                  }
                },
                {
                  "@type": "Question",
                  "name": "ما هو رقم فني تركيب الدش والرسيفر في خميس مشيط؟",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "رقم فني محل حسن للإلكترونيات لتركيب وتصليح الدش والرسيفر في خميس مشيط هو 0558202859، متاح للاتصال أو واتساب."
                  }
                },
                {
                  "@type": "Question",
                  "name": "هل توفرون اشتراكات قنوات بين سبورت في خميس مشيط؟",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "نعم، محل حسن للإلكترونيات يوفر تفعيل اشتراكات قنوات بين سبورت وباقات IPTV مع تركيب واستقبال إشارة عالي الجودة في خميس مشيط."
                  }
                }
              ]
            }),
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify([
              ...
              },
              {
                "@context": "https://schema.org",
                "@type": "Service",
                serviceType: "فني دش وتركيب شاشات خميس مشيط",
                provider: { "@type": "LocalBusiness", name: "محل حسن للإلكترونيات" },
                areaServed: "خميس مشيط",
              },
              {
                "@context": "https://schema.org",
                "@type": "Service",
                serviceType: "اشتراك قنوات بين سبورت وIPTV",
                provider: { "@type": "LocalBusiness", name: "محل حسن للإلكترونيات" },
                areaServed: "خميس مشيط",
              }
            ]),
        ...
        <Layout>
          <section className="sr-only">
            ...
            <ul>
              ...
              <li>تركيب كاميرات خميس مشيط وشركة كاميرات تركيب أبها خميس مشيط</li>
              <li>فني دش وتركيب شاشات خميس مشيط ومحل رسيفرات خميس مشيط</li>
              <li>رقم فني رسيفر ودش تركيب وعامل تصليح دش تركيب لجميع الأحياء</li>
              <li>محل دش حسن للكاميرات في أبها وخميس مشيط وشركة IPTV حسن</li>
              <li>اشتراك قنوات بين سبورت وتفعيل باقات IPTV بجودة عالية</li>
