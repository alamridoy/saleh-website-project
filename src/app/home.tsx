    ...
    >
      ...
      <div className="grid min-h-screen px-8">
        <div className="container relative z-10 my-auto mx-auto grid place-items-center text-center">
          ...
          <div className="sr-only">
            ...
            تركيب وصيانة الدش بخميس مشيط، محل رسيفرات خميس مشيط، محل دش حسن
            كاميرات أبها خميس مشيط، محل دش ورسيفرات تركيب حسن IPTV، رقم فني
            رسيفر ودش تركيب، عامل تصليح دش تركيب، فني دش وتركيب شاشات خميس
            مشيط، شركة IPTV حسن، اشتراك قنوات بين سبورت، شركة كاميرات تركيب
            أبها خميس مشيط، تغطي خدماتنا جميع أحياء ومناطق خميس مشيط.
          </div>
        </div>
      </div>
      ...
      <Script id="localbusiness-schema" type="application/ld+json">
        {JSON.stringify({
          ...
          priceRange: "$$",
          description:
            "فني دش بخميس مشيط متخصص في تركيب وصيانة الدش، بيع رسيفرات وأطباق دش عالية الجودة IPTV وHD، تركيب كاميرات مراقبة وشاشات، اشتراك قنوات بين سبورت، تمديد أسلاك عالية الجودة، وضبط الإشارة باستخدام أحدث الأجهزة. رقم الفني 0558202859.",
        })}
      </Script>
    </section>
  );
